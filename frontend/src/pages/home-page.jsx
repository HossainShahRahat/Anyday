...
export function HomePage() {
    ...
    if (!safeBoards.length) return <div className="loader"><Loader size={Loader.sizes.LARGE} /></div>
    return (
        <section className='home-page'>
            ...
            <header className="home-page-top-header"
                ...
                {loggedInUser?<span className="home-page-login-signup-link"> Welcome {loggedInUser.fullname}</span>
                    ...
                    <Link className='home-page-start-nav' to={`/board/${safeBoards[0]._id}`}>
                        Get Started
            ...
            <div className='animation-container'>
                <div className="carousel__container">
                    ...
                    <div className="carousel__item">
                                <img src={`${heroThree}`} className="carousel__image" alt="hero 3" />
                    </div>
                </div>
            </div>
