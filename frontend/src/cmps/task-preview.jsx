...
import {
  ...
  DUPLICATE_TASK,
  UPDATE_TASK_CHECKED,
  UPDATE_TASK_LABEL_NUMBER,
  UPDATE_TASK_LABEL_TEXT,
...
export function TaskPreview({
  ...
  function handleChange({ target }) {
    ...
    let updateType =
      type === "number" ? UPDATE_TASK_LABEL_NUMBER : UPDATE_TASK_LABEL_TEXT;
  ...
  function handleChangeTaskChecked({ target }, taskId) {
    updateTask(
      safeBoard,
      { taskId, checked: target.checked, groupId: safeGroup.id },
      UPDATE_TASK_CHECKED,
    );
  }
  ...
  return (
    <section
      className={`task-preview ${snapshot.isDragging ? "dragged-task" : ""} `}
      ...
      >
        ...
        >
          ...
          <div
            ...
            className="left-border-task"
          ></div>

          <div
            className="checkbox-row-container-task"
            onClick={() => setIsCheckedShow(true)}
          >
            <input
              className="row-checkbox-task"
            ...
            <button
              ...
              style={
                task.comments && task.comments.length
                  ? { paddingRight: "5px" }
                  : { paddingRight: "19px", paddingLeft: "20px" }
              }
            >
              {!(task.comments && task.comments.length) && (
                <Icon
