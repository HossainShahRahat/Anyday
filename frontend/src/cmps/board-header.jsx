    ...
    <Fragment>
      <div className="header-mobile">
        ...
        <div className="board-title-mobile">
          <div className="title-mobile-txt">{board ? board.title : ""}</div>
        </div>
      ...
      <div className="mobile-header-filter">
        <div
          ...
          style={{ display: isFilterOn ? `none` : `block` }}
        >
        ...
        <div
          className="mobile-fitler-container"
          style={{ display: isFilterOn ? `none` : `block` }}
        >
          <Icon
            iconType={Icon.type.SVG}
        ...
        <div className="search-mobile-container">
          ...
          <div
            className="input-slider-mobile"
            style={{ left: isFilterOn ? `0px` : `400px` }}
          >
            <button
